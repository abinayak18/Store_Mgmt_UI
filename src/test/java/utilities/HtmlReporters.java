...
public class HtmlReporters extends Applet {
	...
	public static void createDetailedReport() throws Exception
	{
		...
		File file = new File(BeforeAndAfterStepDefinition.filePath()+"/"+"Results_"+BeforeAndAfterStepDefinition.timeStamp+".html"); 
		...
		writer.write("<TR><TD align='left'><img src='file:///"+workingDir+"/Logos/"+config.getProperty("Vedams_logo")+".png' alt='"+config.getProperty("Vedams_logo")+"' height='85' width='200'> </TD>");
		writer.write("<TD align='center'><H4 align='center'><font color='660066' face='arial' color='#E0E0E0' size=5><b>Detailed report</b></H4></TD>");
		writer.write("<TD align='right'><img src='file:///"+workingDir+"/Logos/vedams.png' alt='Vedams' height='85' width='200'>  </TD></TR>");
	...
	public static void createHtmlSummaryReport() throws Exception{
		File file = new File(BeforeAndAfterStepDefinition.filePath()+"/"+"SummaryResults_"+BeforeAndAfterStepDefinition.timeStamp+".html");//"SummaryReport.html"
		Writer writer = null;
		...
		try{
			...
			//writer.write("<TD align='right'><img src='file:///"+workingDir+"/Logos/Inventory.png' alt='Inventory' height='85' width='200'>  </TD></TR>");
			writer.write("<TD align='right'><img src='file:///"+workingDir+"/Logos/vedams.png' alt='Vedams' height='85' width='200'>  </TD></TR>");
			...
			writer.write("<tr><td align='center'><FONT COLOR='#153E7E' FACE='Arial' SIZE=2.25><b>Module(s)</b></td>" +
					"<td align='center'><FONT COLOR='#153E7E' FACE='Arial' SIZE=2.25><b>Test Case(s)</b></td>" +
			...
			while(iterator1.hasNext())
			{
				...
				if(value.equals("PASS"))
				{
					writer.write("<TD width='30%' bgcolor=green align=center><FONT color=white size=1 face=Arial><B><a href='Results_"+BeforeAndAfterStepDefinition.timeStamp+".html#"+key+"'>"+value+"</a></B></td>"); 
				}
				else
				{
					writer.write("<TD width='30%' bgcolor=red align=center><FONT color=white size=1 face=Arial><B><a href='Results_"+BeforeAndAfterStepDefinition.timeStamp+".html#"+key+"'>"+value+"</a></B></td>");	
				}
	...
	{
		map.clear();
		File file = new File(BeforeAndAfterStepDefinition.filePath()+"Results_"+BeforeAndAfterStepDefinition.timeStamp+".html");//"Results.html"
	...
	public static void onSuccess(String strStepName,String strStepDes){
		File file = new File(BeforeAndAfterStepDefinition.filePath()+"/"+"Results_"+BeforeAndAfterStepDefinition.timeStamp+".html");//"SummaryReport.html"
		Writer writer = null;
	...
	public static void onFailure(String strStepName,String strStepDes){
		...
		try{
			...
			writer.write("<tr><TD width='30%'><FONT color=#153e7e size=1 face=Arial><B>" + strStepName
					+ " </b></td><TD><FONT color=#153e7e size=1 face=Arial><B>" + strStepDes + "</B></td>"
					+ " </td><TD width='10%' bgcolor=red align=center><FONT color=white size=1 face=Arial><B><a href="+strStepDes.replace(" ", "_").replace(":", "_")+"_"+BeforeAndAfterStepDefinition.timeStamp+".jpeg>" + "Failed" + "</a></td></tr>");
